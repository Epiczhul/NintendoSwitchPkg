...
[LibraryClasses.common]
  ...
  # ArmLib moved to MdePkg; ArmMmuLib moved to UefiCpuPkg (edk2-stable202608)
  ArmLib|MdePkg/Library/ArmLib/ArmBaseLib.inf
  ArmMmuLib|UefiCpuPkg/Library/ArmMmuLib/ArmMmuBaseLib.inf
  # ArmPlatformStackLib removed from ArmPlatformPkg (edk2-stable202608)
  CacheMaintenanceLib|ArmPkg/Library/ArmCacheMaintenanceLib/ArmCacheMaintenanceLib.inf
  # CpuExceptionHandlerLib moved to UefiCpuPkg; DefaultExceptionHandlerLib removed (edk2-stable202608)
  CpuExceptionHandlerLib|UefiCpuPkg/Library/CpuExceptionHandlerLib/DxeCpuExceptionHandlerLib.inf
  ArmGenericTimerCounterLib|ArmPkg/Library/ArmGenericTimerPhyCounterLib/ArmGenericTimerPhyCounterLib.inf
  TimeBaseLib|EmbeddedPkg/Library/TimeBaseLib/TimeBaseLib.inf
  TimerLib|ArmPkg/Library/ArmArchTimerLib/ArmArchTimerLib.inf
  # ArmSmcLib moved to MdePkg (edk2-stable202608)
  ArmSmcLib|MdePkg/Library/ArmSmcLib/ArmSmcLib.inf
  ArmHvcLib|ArmPkg/Library/ArmHvcLib/ArmHvcLib.inf
  ArmMonitorLib|ArmPkg/Library/ArmMonitorLib/ArmMonitorLib.inf
  # ArmGicLib and ArmGicArchLib removed; functionality built into ArmGicDxe (edk2-stable202608)
  RegisterFilterLib|MdePkg/Library/RegisterFilterLibNull/RegisterFilterLibNull.inf

  # Compiler Services
  # CompilerIntrinsicsLib moved to MdePkg (edk2-stable202608)
  NULL|MdePkg/Library/CompilerIntrinsicsLib/CompilerIntrinsicsLib.inf
  CompilerIntrinsicsLib|MdePkg/Library/CompilerIntrinsicsLib/CompilerIntrinsicsLib.inf
  # Stack check libraries (edk2-stable202608)
  ...
  # System Libraries
  # EfiResetSystemLib renamed to ResetSystemLib (edk2-stable202608)
  ...
  # Required by PartitionDxe, DxeTpm2MeasureBootLib (edk2-stable202608)
...
[LibraryClasses.common.SEC]
  ...
  # Required by PeilessSec (edk2-stable202608)
...
[Components.common]
  # PEI/SEC - PeiUniCore replaced by PeilessSec (edk2-stable202608)
  ...
  # ArmGicDxe path updated (edk2-stable202608)
